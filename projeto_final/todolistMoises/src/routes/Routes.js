  ...
  return (
    <Stack.Navigator>
      ...
      headerStyle:{backgroundColor:'#46696E', }, headerTitleStyle:{fontSize:30, fontWeight:'bold'}
        ...
        headerStyle:{backgroundColor:'#46696E', }, headerTitleStyle:{fontSize:20, fontWeight:'bold'}}} />

        <Stack.Screen name='SignIn' component={SignIn}  options={{headerTitle:"Cadastrar",
        headerStyle:{backgroundColor:'#46696E', }, headerTitleStyle:{fontSize:30, fontWeight:'bold'}}} />
